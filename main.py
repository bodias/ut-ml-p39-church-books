...
def process_folder(transkribus_folder: str, surnames_db: str, export_file:str, min_edit_distance:int , min_word_size:int):
    ...
    if extracted_text and surnames:        
        surnames_list_db = surnames_db_search(extracted_text, surnames, min_edit_distance, min_word_size)
        surnames_list_regex = surnames_regex_search(extracted_text, min_word_size)
